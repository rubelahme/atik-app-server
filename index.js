...
client.connect((err) => {
  const collection = client.db("ErosUpdate").collection("Atik");
  const collections = client.db("ErosUpdate").collection("Atikimage");
  const ImageCollection = client.db("ErosUpdate").collection("AtikNewImage");
